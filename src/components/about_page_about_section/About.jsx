            ...
            <div className=" flex-wrap flex items-center justify-between">
                ...
                <div className="md:w-[48%] w-full">
                    ...
                    <p className="text-[#ABB2BF] ">
                        ...
                        <br />
                        <br />
                        I’m a self-taught front-end developer based in Anambra
                        State, Nigeria. I can develop responsive websites from
                        scratch and raise them into modern user-friendly web
                        experiences.
                        <br />
                        <br />
                        Transforming my creativity and knowledge into a websites
                        has been my passion over the years. I have been helping
